...
const FEATURES = [
  ...
  },
  {
    name: 'Front End',
    description:
      'I built this site with React and deployed it on Netlify. I used Tailwindcss for styling and all animations. I used Lodash for scroll throttling to handle the document scrolling feature when the user clicks on a nav button. The site contains a lot of images, which caused scrolling to lag and jump. To regain performance I resized many of the images using ImageMagick.',
